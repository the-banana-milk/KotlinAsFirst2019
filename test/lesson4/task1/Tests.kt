...
class Tests {
    ...
    fun factorize() {
        ...
        assertEquals(listOf(7), factorize(7))
    ...
    fun roman() {
        ...
        assertEquals("MCDXXIII", roman(1423))
    ...
    fun russian() {
        ...
        assertEquals("тридцать один", russian(31))
        ...
        assertEquals("девятьсот одна тысяча девятьсот тринадцать", russian(901913))
